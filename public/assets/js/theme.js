...
(function ($) {
    ...
    if (!isMobile) {
      ...
      if ($('.tt-overflow').length) {
        ...
        $.fn.ttIsScrollable = function () {
          return (
            this[0].scrollWidth > this[0].clientWidth || this[0].scrollHeight > this[0].clientHeight
          );
        };
  ...
  window.initPageNavigation = function () {
      ...
      setTimeout(function () {
        if ($('.tt-page-nav').hasClass('tt-pn-scroll')) {
          ...
          $('.tt-page-nav')
            ...
            .each(function () {
              var $this = $(this);
              if ($this.width() > $this.parent().width() && $this.find('span').length === 0) {
                $this.wrapInner('<span></span>');
    ...
    if ($('#ball').length && typeof gsap !== 'undefined') {
      ...
      $('.tt-page-nav').find('.tt-pn-link').off('mouseenter mouseover mouseleave');

      // Page nav hover
      $('.tt-page-nav').each(function () {
        var $pageNav = $(this);
        console.log('Processing page nav, has image:', $pageNav.find('.tt-pn-image').length);
