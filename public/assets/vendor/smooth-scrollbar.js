  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, c) {
        ...
        ('function' == typeof n &&
          ...
          t !== r
            ? (a ? !p && t[e] && (s = !0) : delete t[e], s ? (t[e] = n) : o(t, e, n))
            : s
              ? (t[e] = n)
              : u(e, n));
      ...
      t.exports = function (t, e, n, f, h, g, x) {
        ...
        if (
          (j &&
            ...
            d !== Object.prototype &&
              b.next &&
              (l || i(b) === d || (u ? u(b, d) : 'function' != typeof b[y] && a(b, y, m)),
              c(b, E, !0, !0),
              l && (p[E] = m))),
          'values' == h &&
            A &&
          ...
          if (((w = { values: _('values'), keys: g ? P : _('keys'), entries: _('entries') }), x))
        ...
        getConstructor: function (t, e, n, s) {
          ...
          return (
            i(f.prototype, {
              ...
              forEach: function (t) {
                for (
                  var e, n = h(this), r = u(t, arguments.length > 1 ? arguments[1] : void 0, 3);
                  (e = e ? e.next : n.first);
                )
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        p = !1;
      ([].keys &&
        ('next' in (i = [].keys()) ? (o = u(u(i))) !== Object.prototype && (r = o) : (p = !0)),
        null == r && (r = {}),
        f ||
          a(r, l) ||
          c(r, l, function () {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        if ((g && (m = r(m, y > 2 ? arguments[2] : void 0, 2)), null == x || (v == Array && u(x))))
          ...
          for (p = (l = x.call(d)).next, n = new v(); !(f = p.call(l)).done; b++)
...
***************************************************************************** */
        ...
        return (
          ...
          function (t, n, r) {
            ...
            n.split(/\s+/g).forEach(function (n) {
              (e.push({ elem: t, eventName: n, handler: o }), t.addEventListener(n, o, s()));
            });
          }
        );
      }
      ...
      var O = (function () {
        ...
        T = (function () {
          ...
          return (
            ...
            (t.prototype.update = function (t, e, n) {
              (v(this.element, { display: n <= e ? 'none' : 'block' }), this.thumb.update(t, e, n));
            }),
            t
          );
        })(),
      ...
      function R(t) {
        ...
        function d(e, n) {
          ...
          return e === k.X
            ? g(
                (n / (r.container.width + (s.thumb.realSize - s.thumb.displaySize))) *
                  r.content.width,
                0,
                o.x
              ) - i.x
            : e === k.Y
              ? g(
                  (n / (r.container.height + (h.thumb.realSize - h.thumb.displaySize))) *
                    r.content.height,
                  0,
                  o.y
                ) - i.y
          ...
          i &&
            ...
            (function n(r) {
              ...
              (function (t, e) {
                ...
                return (
                  (0 === a && 0 === s) ||
                    (a > o - 20 ? (f.x = a - o + 20) : a < u + 20 && (f.x = a - u - 20),
      ...
      function F(t) {
        ...
        (o(n, 'touchstart', function (n) {
          (r.track(n),
            t.setMomentum(0, 0),
            0 === i && ((e = t.options.damping), (t.options.damping = Math.max(e, 0.5))),
            i++);
        }),
        ...
        f(t)(
          ...
          function (e) {
            var n = (function (t) {
                if ('deltaX' in t) {
                  var e = G(t.deltaMode);
                  return { x: (t.deltaX / W.STANDARD) * e, y: (t.deltaY / W.STANDARD) * e };
                }
                return 'wheelDeltaX' in t
                  ? { x: t.wheelDeltaX / W.OTHERS, y: t.wheelDeltaY / W.OTHERS }
            ...
            (t.prototype.setPosition = function (t, e, n) {
              ...
              var o = (function (t, e, n) {
                var r = t.options,
                  ...
                  a = t.contentEl;
                return (
                  r.renderByPixels && ((e = Math.round(e)), (n = Math.round(n))),
                  (e = g(e, 0, u.x)),
                  (n = g(n, 0, u.y)),
                  e !== o.x && c.xAxis.show(),
                  n !== o.y && c.yAxis.show(),
                  ...
                  e === o.x && n === o.y
                    ...
                    : ((o.x = e),
                      (o.y = n),
                      v(a, { '-transform': 'translate3d(' + -e + 'px, ' + -n + 'px, 0)' }),
                      c.update(),
