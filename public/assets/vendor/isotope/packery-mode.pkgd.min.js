...
(!(function (a, b) {
  ...
  return (
    ...
    (b.getMaximalFreeRects = function (b) {
      ...
      return (
        this.y < b.y &&
          ((c = new a({ x: this.x, y: this.y, width: this.width, height: b.y - this.y })),
          d.push(c)),
        ...
        this.x < b.x &&
          ((c = new a({ x: this.x, y: this.y, width: b.x - this.x, height: this.height })),
          d.push(c)),
        d
      );
    }),
    ...
    return (
      (f.moveTo = function (a, b) {
        var c = Math.abs(this.position.x - a),
          ...
          e =
            this.layout.dragItemCount && !this.isPlacing && !this.isTransitioning && 1 > c && 1 > d;
