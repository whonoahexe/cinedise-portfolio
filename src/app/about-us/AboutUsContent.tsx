...
export default function AboutUsContent() {
  ...
  useEffect(() => {
        ...
        if (contentCarouselRef.current) {
          ...
          if (swiperEl && !(swiperEl as HTMLElement & { swiper?: unknown }).swiper) {
            ...
            if (contentSwiperInstance.current) {
              (
                contentSwiperInstance.current as { destroy: (a: boolean, b: boolean) => void }
              ).destroy(true, true);
            }
        ...
        if (testimonialsSliderRef.current) {
          ...
          if (swiperEl && !(swiperEl as HTMLElement & { swiper?: unknown }).swiper) {
            ...
            if (testimonialsSwiperInstance.current) {
              (
                testimonialsSwiperInstance.current as { destroy: (a: boolean, b: boolean) => void }
              ).destroy(true, true);
            }
    ...
    return () => {
      ...
      if (contentSwiperInstance.current) {
        (contentSwiperInstance.current as { destroy: (a: boolean, b: boolean) => void }).destroy(
          true,
          true
        );
      }
            ...
            <div className="tt-col-lg-4 padding-right-lg-5-p">
              <div className="tt-heading tt-heading-sm margin-bottom-60 anim-fadeinup">
                <h2 className="tt-heading-title text-gray">
                  The
                  <br className="hide-from-md" /> Idea
                </h2>
              </div>
            </div>
            ...
            <div className="tt-col-lg-8">
              <div className="text-xxlg font-alter">
                <p className="anim-fadeinup">
                  Cinedise is a full-service solution for all your video, film production, and
                  marketing needs. We specialize in delivering a cinematic experience within a
                  highly competitive budget. Our dedicated creative team is committed to producing
                  high-quality content that elevates your brand above the rest.
                </p>
                <p className="anim-fadeinup">
                  Teams: As a comprehensive studio, CINEDISE houses all essential departments and
                  Heads of Departments (HODs) to ensure a seamless workflow — all coordinated in a
                  single meeting.
                </p>
              </div>
            </div>
      ...
      <div className="tt-section padding-top-xlg-150 padding-bottom-xlg-200">
        <div className="tt-section-inner tt-wrap">
          ...
          <div className="tt-accordion tt-ac-xlg tt-ac-borders">
            <div className="tt-accordion-item anim-fadeinup">
              ...
              <div className="tt-accordion-content max-width-800">
                <p>
                  Focused on concept development, storytelling, and shot listing to provide a clear
                  and strategic vision for your shoot or product.
                </p>
              </div>
            </div>
            ...
            <div className="tt-accordion-item anim-fadeinup">
              ...
              <div className="tt-accordion-content max-width-800">
                <p>
                  Expertise across Direction, Art Direction, Cinematography, Sound, and Makeup to
                  bring your vision to life on set.
                </p>
              </div>
            </div>
            ...
            <div className="tt-accordion-item anim-fadeinup">
              ...
              <div className="tt-accordion-content max-width-800">
                <p>
                  Specialized professionals in Color Grading and VFX ensure your final product meets
          ...
          <div className="tt-btn tt-btn-dark tt-btn-block margin-top-60 anim-fadeinup">
            <Link href="/#team" data-hover="View Team">
              View Team
            </Link>
          </div>
          ...
          <div className="tt-heading tt-heading-xxlg tt-heading-stroke tt-heading-center margin-top-150 anim-fadeinup">
            ...
            <h3 className="tt-heading-subtitle text-gray">
              With numerous studios available, it&apos;s only natural to ask — why CINEDISE?
      ...
      <div className="tt-section padding-top-xlg-150 padding-bottom-xlg-150 padding-left-sm-3-p padding-right-sm-3-p bg-white-accent-2">
        <div className="tt-section-inner tt-wrap">
          <div
            ...
            className="tt-testimonials-slider cursor-drag ts-scale-down ts-hide-navigation anim-fadeinup text-center"
            data-loop="true"
            data-simulate-touch="true"
            data-speed="900"
          >
            <div className="swiper">
              <div className="swiper-wrapper">
                <div className="swiper-slide font-alter">
                  <div className="tt-ts-item">
                    <div className="tt-ts-text">
                      CINEDISE comprises seven specialized departments — Cinematography, Editing,
                      DI, VFX, Motion Design/Animation, Poster/Image Design, and UI/UX — each led by
                      experienced supervisors to ensure top-tier results.
                    </div>
                ...
                <div className="swiper-slide font-alter">
                  <div className="tt-ts-item">
                    <div className="tt-ts-text">
                      From concept to delivery, we simplify the process. One meeting is all it takes
                      to align with your vision. Our HODs are dedicated to pushing creative
                      boundaries and delivering precisely what you need.
                    </div>
                ...
                <div className="swiper-slide font-alter">
                  <div className="tt-ts-item">
                    <div className="tt-ts-text">
                      We understand the importance of timelines. Our team is equipped to deliver
                      high-quality outputs within the shortest possible time frames.
                    </div>
                ...
                <div className="swiper-slide font-alter">
                  <div className="tt-ts-item">
                    <div className="tt-ts-text">
                      Location is never a constraint. Our production team is capable of executing
                      shoots across any location in India.
                    </div>
                ...
                <div className="swiper-slide font-alter">
                  <div className="tt-ts-item">
                    <div className="tt-ts-text">
                      CINEDISE collaborates with clients, artists, and studios worldwide. We accept
                      payments in all major currencies and provide high-quality deliverables,
                      including 1-year data retention via Google Drive.
                    </div>
