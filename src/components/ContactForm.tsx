    ...
    <form onSubmit={sendEmail} className="tt-form-minimal anim-fadeinup">
      ...
      <div className="tt-btn tt-btn-light-outline margin-top-40">
        <button
          ...
          disabled={isSubmitting}
          className={`relative transition-all duration-200 ${isSubmitting ? 'cursor-not-allowed opacity-70' : ''}`}
        >
      ...
      {/* Status Messages */}
      <div
        className={`mt-12 transition-all duration-300 ease-out ${submitStatus ? 'translate-y-0 opacity-100' : 'pointer-events-none -translate-y-2 opacity-0'}`}
      >
